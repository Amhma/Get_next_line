...
clang -Wall -Werror -Wextra main_exemple.c
...
clang -Wall -Werror -Wextra -D BUFFER_SIZE=1 ../Get_next_line/get_next_line.c ../Get_next_line/get_next_line_utils.c main_other.c
...
clang -Wall -Werror -Wextra -D BUFFER_SIZE=42 ../Get_next_line/get_next_line.c ../Get_next_line/get_next_line_utils.c main_other.c
...
clang -Wall -Werror -Wextra -D BUFFER_SIZE=10000000 ../Get_next_line/get_next_line.c ../Get_next_line/get_next_line_utils.c main_other.c
